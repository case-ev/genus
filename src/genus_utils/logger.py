...
genus_utils.logger
------------------------
Creation and setup for the logger used by genus and its related
packages.
"""
...
from genus_utils.console import ShellColors


LOGGER = logging.Logger("genus")
...
class CustomFormatter(logging.Formatter):
    """Custom formatter for the genus logger"""
...
def setup_logger(quiet=False, debug=False, verbose=False, log_dir=False):
    ...
    debug : bool, optional
        ...
        functionality that might be useful when debugging a genus
