...
def test_creation():
    ...
    c1 = Chromosome("01010101")
    c2 = Chromosome("01010101")
    assert c1 == c2
    assert len(c1) == 8
    assert len(c2) == 8
    assert c1.size == 8
...
def test_str():
    ...
    assert repr(c1) == "Chromosome(code='01010101')"
    ...
    assert empty_c1.code == ""
    assert empty_c2.code == ""
    assert repr(empty_c1) == "Chromosome(code='')"
    assert repr(empty_c2) == "Chromosome(code='')"
    assert str(empty_c1) == ""
    assert str(empty_c2) == ""
